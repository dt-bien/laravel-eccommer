            ...
            <li class="nav-item active">
                ...
                <div id="collapseOne" class="collapse" aria-labelledby="headingTwo"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{asset('/admin/product')}}">Xem Tất Cả</a>
                        <a class="collapse-item" href="{{asset('/admin/addproduct')}}">Thêm Sản Phẩm</a>
                        <a class="collapse-item" href="{{asset('/admin/addproductdetails')}}">Thêm Chi Tiết Sản Phẩm</a>
            ...
            <li class="nav-item active">
                ...
                <div id="collapseFive" class="collapse" aria-labelledby="headingTwo"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{asset('/admin/category')}}">Xem Tất Cả</a>
                        <a class="collapse-item" href="{{asset('/admin/addcategory')}}">Thêm Loại Sản Phẩm</a>
            ...
            <li class="nav-item active">
                ...
                <div id="collapseSix" class="collapse" aria-labelledby="headingTwo"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{asset('/admin/productgroup')}}">Xem tất cả</a>
                        <a class="collapse-item" href="{{asset('/admin/addproductgroup')}}">Thêm Nhóm Sản Phẩm</a>
            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{asset('/admin/brand')}}">Xem tất cả</a>
                        <a class="collapse-item" href="{{asset('/admin/addbrand')}}">Thêm Thương Hiệu</a>
            ...
            <li class="nav-item active">
                ...
                <div id="collapseThree" class="collapse" aria-labelledby="headingTwo"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{asset('/admin/client')}}">Xem tất cả</a>
            ...
            <li class="nav-item active">
                ...
                <div id="collapseFour" class="collapse" aria-labelledby="headingTwo"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{asset('/admin/orders')}}">Xem Tất Cả</a>
                        <a class="collapse-item" href="buttons.html">Xem Theo Tháng</a>
                        <a class="collapse-item" href="buttons.html">Xem Theo Sản Phẩm</a>
                        <a class="collapse-item" href="buttons.html">Xem Theo Thương Hiệu</a>
